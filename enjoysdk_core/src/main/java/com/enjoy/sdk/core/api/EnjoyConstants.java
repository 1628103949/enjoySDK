 ...
 * Author: ranger
 */
public class EnjoyConstants {

    public static final String ENJOY_WEB_OBJ = "Enjoy";
    public static final String ENCRYPT_IV = "quwan123";
    ...
    //自营平台特有默认配置
    public static final String ENJOY_USER_AGREEMENT = "http://qwangame.com/uagree/uerService.html";
    public static final String ENJOY_USER_FIND_PWD = "http://qwangame.com/find/findAccount.html";
