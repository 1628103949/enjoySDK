...
public class EnjoyPayInfo {
    ...
    public HashMap<String, String> toHash() {
        ...
        info.put(EnjoyConstants.PAY_ORDER_ID, payOrderId);
        info.put(EnjoyConstants.PAY_MONEY, payMoney + "");
        info.put(EnjoyConstants.PAY_ORDER_NAME, payOrderName);
        info.put(EnjoyConstants.PAY_EXT, payExt);
        info.put(EnjoyConstants.PAY_ROLE_ID, payRoleId);
        info.put(EnjoyConstants.PAY_ROLE_NAME, payRoleName);
        info.put(EnjoyConstants.PAY_ROLE_LEVEL, payRoleLevel + "");
        info.put(EnjoyConstants.PAY_SERVER_ID, payServerId);
        info.put(EnjoyConstants.PAY_SERVER_NAME, payServerName);
        info.put(EnjoyConstants.PAY_ROLE_VIP, payRoleVip + "");
        info.put(EnjoyConstants.PAY_ROLE_BALANCE, payRoleBalance + "");
        info.put(EnjoyConstants.PAY_RATE, payRate + "");
        return info;
    }
    ...
    public String toString() {
        try {
            ...
            HashMap<String, String> info = new HashMap<>();
            data.put(EnjoyConstants.PAY_ORDER_ID, payOrderId);
            data.put(EnjoyConstants.PAY_MONEY, payMoney + "");
            data.put(EnjoyConstants.PAY_ORDER_NAME, payOrderName);
            data.put(EnjoyConstants.PAY_EXT, payExt);
            data.put(EnjoyConstants.PAY_ROLE_ID, payRoleId);
            data.put(EnjoyConstants.PAY_ROLE_NAME, payRoleName);
            data.put(EnjoyConstants.PAY_ROLE_LEVEL, payRoleLevel + "");
            data.put(EnjoyConstants.PAY_SERVER_ID, payServerId);
            data.put(EnjoyConstants.PAY_SERVER_NAME, payServerName);
            data.put(EnjoyConstants.PAY_ROLE_VIP, payRoleVip);
            data.put(EnjoyConstants.PAY_ROLE_BALANCE, payRoleBalance);
            info.put(EnjoyConstants.PAY_RATE, payRate + "");
    ...
    public static class PayBuilder {
        ...
        public EnjoyPayInfo build() {
            EnjoyPayInfo payInfo = new EnjoyPayInfo();
