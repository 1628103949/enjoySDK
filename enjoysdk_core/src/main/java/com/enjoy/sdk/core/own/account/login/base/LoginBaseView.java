package com.enjoy.sdk.core.own.account.login.base;
...
import com.enjoy.sdk.framework.view.loading.AVLoadingIndicatorView;
import com.enjoy.sdk.core.own.account.login.AgreementDialog;
...
public abstract class LoginBaseView<T> {
    ...
    public T build() {
        fatherView = LayoutInflater.from(mContext).inflate(ResUtil.getLayoutID("enjoy_login_base_layout", mContext), null);
    ...
    protected void closeDialog() {
        onViewFinishLoad();
        mLoginDialog.getEnjoyAccount().onLoginViewClose();
    }
