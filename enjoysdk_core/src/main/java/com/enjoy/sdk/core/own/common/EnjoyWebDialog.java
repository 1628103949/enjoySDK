 ...
 * Author: ranger
 */
public class EnjoyWebDialog extends BaseDialog<EnjoyWebDialog> {
    ...
    public EnjoyWebDialog(Activity act, String title, String url) {
        super(act, false);
        this.loadUrl = url;
        this.mActivity = act;
        this.mTitle = title;
        Bus.getDefault().register(EnjoyWebDialog.this);
    }


    @Override
    public View onCreateView() {
        View containerView = LayoutInflater.from(mContext).inflate(ResUtil.getLayoutID("enjoy_web_dialog", mActivity), null);
    ...
    private void initWebView() {
        ...
        //处理通用界面开放的接口
        sdkWebViewHolder.getSdkWebView().addJavascriptInterface(new EnjoyWebDialog.WebInterface(), EnjoyConstants.ENJOY_WEB_OBJ);
    ...
    public void dismiss() {
        ...
        Bus.getDefault().unregister(EnjoyWebDialog.this);
    }
