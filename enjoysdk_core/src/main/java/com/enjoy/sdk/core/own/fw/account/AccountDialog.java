package com.enjoy.sdk.core.own.fw.account;
...
import com.enjoy.sdk.framework.utils.SizeUtils;
...
import com.enjoy.sdk.core.http.params.PhoneBindCodeParam;
import com.enjoy.sdk.core.http.params.PhoneBindVerifyParam;
...
public class AccountDialog extends BaseDialog<AccountDialog> {
        ...
        public void onFinish() {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        resetCodeBtn.setBackgroundResource(ResUtil.getDrawableID("enjoy_fw_btn_bg_tran", mContext));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    resetCodeBtn.setText(ResUtil.getStringID("enjoy_get_phone_code", mContext));
        ...
        public void onFinish() {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    try {
                        bindCodeBtn.setBackgroundResource(ResUtil.getDrawableID("enjoy_fw_btn_bg_tran", mContext));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    bindCodeBtn.setText(ResUtil.getStringID("enjoy_get_phone_code", mContext));
    ...
    public View onCreateView() {
        View containerView = LayoutInflater.from(mContext).inflate(ResUtil.getLayoutID("enjoy_float_account_dialog", mContext), null);
    ...
    private void initMainView() {
        ...
        titleTv.setText(ResUtil.getStringID("enjoy_account", mActivity));
    ...
    private void initResetView() {
        ...
        titleTv.setText(ResUtil.getStringID("enjoy_reset_pwd", mActivity));
...
//        resetPhoneEt.setRawInputType(Configuration.KEYBOARD_QWERTY);
    ...
    private void resetPwdGetCode(String phone) {
        ...
        x.http().post(resetCodeParam, new Callback.CommonCallback<EnjoyResponse>() {
            @Override
    ...
    private void initBindView() {
        ...
        titleTv.setText(ResUtil.getStringID("enjoy_bind_phone", mActivity));
    ...
    private void bindPhoneGetCode(String phone) {
        ...
        x.http().post(phoneBindCodeParam, new Callback.CommonCallback<EnjoyResponse>() {
            @Override
            public void onSuccess(EnjoyResponse result) {
                ViewUtils.sdkShowTips(mContext, result.msg);
    ...
    private void bindPhoneVerify(final String phone, String code) {
        ...
        x.http().post(phoneBindVerifyParam, new Callback.CommonCallback<EnjoyResponse>() {
    ...
    private void initRealnameView() {
        ...
        titleTv.setText(ResUtil.getStringID("enjoy_certification", mActivity));
