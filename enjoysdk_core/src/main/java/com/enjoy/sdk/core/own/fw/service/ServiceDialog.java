package com.enjoy.sdk.core.own.fw.service;
...
import com.enjoy.sdk.framework.view.circleimageview.CircleImageView;
...
public class ServiceDialog extends BaseDialog<ServiceDialog> {
    ...
    public View onCreateView() {
        View containerView = LayoutInflater.from(mContext).inflate(ResUtil.getLayoutID("enjoy_service_dialog", mContext), null);
...
//        }
    ...
    private void loadImage(String logoUrl) {
        ImageOptions imageOptions = new ImageOptions.Builder().
                setLoadingDrawableId(ResUtil.getDrawableID("enjoy_service", mContext))
                .setFailureDrawableId(ResUtil.getDrawableID("enjoy_service", mContext))
                .build();
