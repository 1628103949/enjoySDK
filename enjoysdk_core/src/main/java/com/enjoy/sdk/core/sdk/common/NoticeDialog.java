package com.enjoy.sdk.core.sdk.common;
...
public class NoticeDialog extends BaseDialog<NoticeDialog> {
    ...
    public View onCreateView() {
        View containerView = LayoutInflater.from(mContext).inflate(ResUtil.getLayoutID("enjoy_notice_dialog", mActivity), null);
    ...
    private void initWebView() {
        ...
        //处理通用界面开放的接口
        sdkWebViewHolder.getSdkWebView().addJavascriptInterface(new NoticeDialog.WebInterface(), EnjoyConstants.ENJOY_WEB_OBJ);
