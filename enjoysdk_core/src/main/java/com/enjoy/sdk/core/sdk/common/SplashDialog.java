...
public class SplashDialog extends Dialog {
    ...
    public void onAttachedToWindow() {
        ...
        if (mContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
            //竖屏
            splashBitmap = TUitls.getImageFromAssetsFile(mContext, "enjoy/enjoy_splash_port.png");
        } else {
            //横屏
            splashBitmap = TUitls.getImageFromAssetsFile(mContext, "enjoy/enjoy_splash_land.png");
        }
