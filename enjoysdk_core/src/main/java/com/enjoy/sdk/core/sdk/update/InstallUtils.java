...
import com.enjoy.sdk.framework.utils.ShellUtils;
    ...
    public static Intent getInstallAppIntent(Context context, File appFile) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri fileUri = FileProvider.getUriForFile(context, context.getApplicationContext().getPackageName() + ".EnjoyFileProvider", appFile);
