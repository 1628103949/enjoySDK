package com.enjoy.sdk.core.sdk.netstate;
...
public class NetCheck {
    ...
    public static void checkNetNotExit(Activity act, @NonNull final NetFlowCallback callback) {
        ...
        ViewUtils.showTipsConfirm(act, act.getString(ResUtil.getStringID("enjoy_network_error", act)), new TipsDialog.TipsConfirmCallback() {
            @Override
