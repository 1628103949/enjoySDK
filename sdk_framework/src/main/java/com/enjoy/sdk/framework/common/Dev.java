package com.enjoy.sdk.framework.common;
...
import com.enjoy.sdk.framework.utils.PhoneUtils;
...
public class Dev {
    ...
    private final static String FILE_DIR = ".dev_enjoy";
    private final static String SP_NAME = "dev_enjoy";
...
//        imei = getLocalData(getDeviceFileName() + IMEI_NAME);
//        if (!TextUtils.isEmpty(imei)) {
...
//    }
    ...
    private static void setSPString(Context ctx, String key, String value) {
        ...
        editor.putString(key, EnjoyEncrypt.encryptInfo(ENCODE_KEY, value));
        editor.apply();
    }

    private static String getSPString(Context ctx, String key, String dValue) {
        SharedPreferences sharedPreferences = ctx.getSharedPreferences(SP_NAME, Context.MODE_PRIVATE);
        return EnjoyEncrypt.decryptInfo(ENCODE_KEY, sharedPreferences.getString(key, dValue));
    }
