package com.enjoy.sdk.framework.safe;
 ...
 * Author: ranger
 */
public class EnjoyEncrypt {

    private static final String TINY_FLAG = "quwangame.com.com";
    ...
    public static String encryptDInfo(String key, String iv, String dInfo) {
        ...
        try {
            ...
            Log.e("enjoyiv", Arrays.toString(enIv));
