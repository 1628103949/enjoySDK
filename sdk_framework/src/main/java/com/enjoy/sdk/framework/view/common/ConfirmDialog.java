package com.enjoy.sdk.framework.view.common;
...
public class ConfirmDialog extends BaseDialog<ConfirmDialog> {
    ...
    public View onCreateView() {
        View container = LayoutInflater.from(mContext).inflate(ResUtil.getLayoutID("enjoy_fw_common_confirm_layout", mContext), null);
