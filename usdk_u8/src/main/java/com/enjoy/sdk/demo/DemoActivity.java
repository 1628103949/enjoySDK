...
public class DemoActivity extends Activity implements View.OnClickListener {
    private String appkey = "QINGYUNZHUAN20210305PUTONG";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.enjoy_demo_act);
        ...
        EnjoySdkApi.getInstance().setLogoutCallback(new EnjoyLogoutCallback() {
            ...
            public void onLogout() {
                ...
                showToast("SDK注销成功！");
                //再次调用SDK登录方法，重新登录
                EnjoySdkApi.getInstance().sdkLogin(DemoActivity.this, new EnjoyCallback() {
                    @Override
        ...
        EnjoySdkApi.getInstance().sdkOnCreate(DemoActivity.this);
    ...
    protected void onRestart() {
        super.onRestart();
        EnjoySdkApi.getInstance().sdkOnRestart(DemoActivity.this);
    }

    @Override
    protected void onStart() {
        super.onStart();
        EnjoySdkApi.getInstance().sdkOnStart(DemoActivity.this);
    }

    @Override
    protected void onResume() {
        super.onResume();
        EnjoySdkApi.getInstance().sdkOnResume(DemoActivity.this);
    }

    @Override
    protected void onPause() {
        super.onPause();
        EnjoySdkApi.getInstance().sdkOnPause(DemoActivity.this);
    }

    @Override
    protected void onStop() {
        super.onStop();
        EnjoySdkApi.getInstance().sdkOnStop(DemoActivity.this);
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        EnjoySdkApi.getInstance().sdkOnDestroy(DemoActivity.this);
    }

    private void doSDKInit() {
        EnjoySdkApi.getInstance().sdkInit(DemoActivity.this, appkey, new EnjoyCallback() {
            @Override
...
//                doSDKInit();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        EnjoySdkApi.getInstance().sdkOnActivityResult(DemoActivity.this, requestCode, resultCode, data);
    }

    @Override
    protected void onNewIntent(Intent intent) {
        super.onNewIntent(intent);
        EnjoySdkApi.getInstance().sdkOnNewIntent(DemoActivity.this, intent);
    }

    @Override
    public void onConfigurationChanged(Configuration newConfig) {
        super.onConfigurationChanged(newConfig);
        EnjoySdkApi.getInstance().sdkOnConfigurationChanged(DemoActivity.this, newConfig);
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        //targetApi>=23 必须接入
        EnjoySdkApi.getInstance().sdkOnRequestPermissionsResult(DemoActivity.this, requestCode, permissions, grantResults);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.sdkLoginBtn:
                EnjoySdkApi.getInstance().sdkLogin(mActivity, new EnjoyCallback() {
                    @Override
                    public void onSuccess(String userInfo) {
                        //SDK登录成功，登录成功userInfo里包含帐号的token以及帐号相关信息，详情参考文档。
                        //【注意】：
            ...
            case R.id.sdkLogoutBtn:
                //SDK 注销
                EnjoySdkApi.getInstance().sdkLogout(DemoActivity.this);
                showToast("SDK已注销!");
                break;

            case R.id.sdkIsLoginBtn:
                //返回SDK是否已登录
                boolean isLogined = EnjoySdkApi.getInstance().isLogined();
...
//                });
            ...
            case R.id.sdkPayBtn:
                ...
                EnjoySdkApi.getInstance().sdkPay(DemoActivity.this, new EnjoyPayInfo.PayBuilder()
                        //CP订单号，全局唯一，不可重复，【必传】
            ...
            case R.id.sdkExitBtn:
                EnjoySdkApi.getInstance().sdkGameExit(DemoActivity.this, new EnjoyCallback() {
                    @Override
                    public void onSuccess(String info) {
            ...
            case R.id.creatRoleBtn:
                EnjoySdkApi.getInstance().sdkSubmitInfo(DemoActivity.this,
                        new EnjoySubmitInfo.SubmitBuilder()
                                //角色ID，建议数字【必传】
                                .submitRoleId("100100")
                                //角色名称，【必传】
                                ...
                                //CP扩展字段，无则不传，【选传】
                               // .submitExt("CP扩展字段")
                                .submitType(EnjoyConstants.SUBMIT_TYPE_CREATE)
                                .build(),
                        new EnjoyCallback() {
                            @Override
                            public void onSuccess(String info) {
            ...
            case R.id.submitDataBtn:
                EnjoySdkApi.getInstance().sdkSubmitInfo(DemoActivity.this, new EnjoySubmitInfo.SubmitBuilder()
                                //角色ID，建议数字，【必传】
                                .submitRoleId("100100")
                                //角色名称，【必传】
                                .submitRoleName("海绵宝宝爱睡觉")
                                ...
                                //CP扩展字段，无则不传，【选传】
                                .submitExt("CP扩展字段")
                                .submitType(EnjoyConstants.SUBMIT_TYPE_ENTER)
                                .build(),
                        new EnjoyCallback() {
                            @Override
                            public void onSuccess(String info) {
            ...
            case R.id.upgradeDataBtn:
                EnjoySdkApi.getInstance().sdkSubmitInfo(DemoActivity.this, new EnjoySubmitInfo.SubmitBuilder()
                                ...
                                //CP扩展字段，无则不传，【选传】
                                .submitExt("CP扩展字段")
                                .submitType(EnjoyConstants.SUBMIT_TYPE_UPGRADE)
                                .build(),
                        new EnjoyCallback() {
                            @Override
                            public void onSuccess(String info) {
            ...
            case R.id.updateDataBtn:
                EnjoySdkApi.getInstance().sdkSubmitInfo(DemoActivity.this, new EnjoySubmitInfo.SubmitBuilder()
                                ...
                                //CP扩展字段，无则不传，【选传】
                                .submitExt("CP扩展字段")
                                .submitType(EnjoyConstants.SUBMIT_TYPE_UPDATE)
                                .build(),
                        new EnjoyCallback() {
                            @Override
                            public void onSuccess(String info) {
            ...
            case R.id.getConfigBtn:
                String tinyConfig = EnjoySdkApi.getInstance().sdkGetConfig(DemoActivity.this);
                try {
